 ...
 */
public class CropImageActivity extends BaseImageEditActivity
...
///storage/emulated/0/DCIM/Screenshots/Screenshot_2021-01-12-21-04-36-353_com.mymedisage.medisageapp.png
        Bundle bundle = getIntent().getBundleExtra(CropImage.CROP_IMAGE_EXTRA_BUNDLE);
        mCropImageUri = bundle.getParcelable(CropImage.CROP_IMAGE_EXTRA_SOURCE);
     //   mCropImageUri = Uri.parse("/storage/emulated/0/DCIM/Screenshots/Screenshot_2021-08-24-14-20-59-478_com.mymedisage.medisageapp.png");
        //File imgFile = new  File("/storage/emulated/0/DCIM/Screenshots/Screenshot_2021-08-24-14-20-59-478_com.mymedisage.medisageapp.png");
        File imgFile = new  File(String.valueOf(mCropImageUri));
        mOptions = bundle.getParcelable(CropImage.CROP_IMAGE_EXTRA_OPTIONS);

        Log.d("________mCropImageUri:",""+mCropImageUri);
