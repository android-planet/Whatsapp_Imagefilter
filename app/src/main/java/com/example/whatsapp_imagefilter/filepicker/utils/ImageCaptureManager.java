...
import com.example.whatsapp_imagefilter.StorageConstant;
...
// Create the File where the photo should go
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                //  selectedImagePath = StorageConstant.getPath(this, result.uri)

                // Uri photoURI = StorageConstant.getPath(context, PickerManager.getInstance().getProviderAuthorities(), newFile);
                Uri photoURI = FileProvider.getUriForFile(mContext, "com.example.whatsapp_imagefilter.provider", newFile);
